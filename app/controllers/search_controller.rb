class SearchController < ApplicationController
  ...
  def search_by_player
    ...
    if params[:player_id].present?
      ...
      @players = Player.where("MATCH(name) AGAINST (? IN BOOLEAN MODE) OR MATCH(full_name) AGAINST (? IN BOOLEAN MODE)", words_for_full_text_search, words_for_full_text_search)
